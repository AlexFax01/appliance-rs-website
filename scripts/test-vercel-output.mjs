...
const payload={name:'Controlled QA',phone:'8645550100',email:'',applianceType:'washer-dryer',selectedProblemIds:['dryer-not-heating'],problem:'',zipCode:'99999',preferredContact:'call',bestTime:'Anytime',consent:true,formStartedAt:1};
